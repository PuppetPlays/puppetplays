...
const PARTNERS = {
  ...
  upvm: 'https://www.univ-montp3.fr/',
  humanum: 'https://www.huma-num.fr',
  rir: 'https://rirra21.www.univ-montp3.fr',
  intactile: 'https://intactile.com',
};
                  ...
                  {Object.entries(PARTNERS).map(([partner, url]) => (
                    <li key={partner}>
                      <a href={url} target="_blank" rel="noopener noreferrer">
                        <img height="60" src={`/logo-${partner}.png`} />
                      </a>
                    </li>
                  ))}
                </ul>
          ...
          <div className={styles.contentInner}>
            <div className={styles.intro}>
              <div className={styles.introContent}>
                <h1 className={styles.introSubtitle}>{t('introSubtitle')}</h1>
              ...
              <div className={styles.introMedia}>
                <img src="/home-intro-illustration.png" />

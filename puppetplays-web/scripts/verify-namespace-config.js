...
log(
  '1. Vérification des fichiers de traduction pour chaque namespace déclaré:',
  'cyan',
);
...
log(
  '\n\n2. Vérification des fichiers non déclarés dans la configuration:',
  'cyan',
);

...
const missingTranslations = {
  common: {
    fr: {
      ...
      meta: {
        animationTechniques: {
          description: "Explorez les différentes techniques d'animation utilisées dans le théâtre de marionnettes"
        },
        discoveryPaths: {
    ...
    en: {
      ...
      meta: {
        animationTechniques: {
          description: "Explore the different animation techniques used in puppet theatre"
        },
        discoveryPaths: {
  ...
  project: {
    fr: {
      scientificPublications: {
        ...
        metaDescription: "Explorez nos publications scientifiques et recherches académiques",
        pageDescription: "Cette page rassemble l'ensemble des publications scientifiques produites dans le cadre du projet PuppetPlays.",
      ...
      videos: {
        exploreIntro: "Explorez notre collection de vidéos sur le théâtre de marionnettes",
        ...
        metaDescription: "Collections de vidéos sur le théâtre de marionnettes - Projet PuppetPlays"
      },
      publication: {
        ...
        pdfErrorMessage: "Impossible de charger le document. Veuillez essayer d'ouvrir le document directement sur HAL.",
    ...
    en: {
      scientificPublications: {
        ...
        metaDescription: "Explore our scientific publications and academic research",
        pageDescription: "This page brings together all the scientific publications produced as part of the PuppetPlays project.",
      ...
      videos: {
        ...
        metaDescription: "Puppet theatre video collections - PuppetPlays Project"
      },
      publication: {
        ...
        pdfErrorMessage: "Unable to load document. Please try opening the document directly on HAL.",
  ...
  ['fr', 'en'].forEach(locale => {
    ...
    Object.keys(missingTranslations).forEach(namespace => {
      ...
      if (fs.existsSync(filePath)) {
        ...
        const merged = deepMerge(existing, missingTranslations[namespace][locale]);
        ...
        fs.writeFileSync(filePath, JSON.stringify(missingTranslations[namespace][locale], null, 2) + '\n');

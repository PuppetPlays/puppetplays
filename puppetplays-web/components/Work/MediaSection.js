  ...
  return (
    <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.9987 13.0004V4H3V5.9995H3.00366V13.0004L13.9987 13.0004ZM13.0057 5.00005H3.99294V8.01916L5.50284 6.1943L9.82644 12.0004H13.0057V5.00005ZM3.99294 12.0004H8.58527L5.46184 7.80598L3.99294 9.58129V12.0004Z"
      />
    </svg>
  );
};
  ...
  return (
    <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.98611 4C3.88921 4 3 4.89543 3 6V11C3 12.1046 3.88921 13 4.98611 13H12.0139C13.1108 13 14 12.1046 14 11V6C14 4.89543 13.1108 4 12.0139 4H4.98611ZM7.10413 10.5981L11.1647 8.49969L7.10413 6.40125V10.5981Z"
      />
    </svg>
  );
};

...
const ErrorBoundary = ({ children, fallback }) => {
  ...
  const defaultFallback = (
    <div className="p-6 mx-auto my-8 max-w-md border border-red-300 rounded-md bg-red-50 text-center">
      <h2 className="text-xl font-semibold text-red-700 mb-2">{t('common:error.title', 'Something went wrong')}</h2>
      <p className="text-red-600 mb-4">{t('common:error.message', 'An error occurred while rendering this component.')}</p>
      <button

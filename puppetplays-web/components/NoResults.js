  ...
  const icons = {
    ...
    search: (
      <svg 
        ...
        style={{ margin: '0 auto 24px' }}
      >
        <circle cx="11" cy="11" r="7" stroke="var(--color-brand)" strokeWidth="2"/>
        <path d="M20 20L16 16" stroke="var(--color-brand)" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    ),
    info: (
      <svg 
      ...
      >
        <circle cx="12" cy="12" r="10" stroke="var(--color-brand)" strokeWidth="2"/>
        <path d="M12 7V12" stroke="var(--color-brand)" strokeWidth="2" strokeLinecap="round"/>
